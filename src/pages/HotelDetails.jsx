...
const getAmenityIcon = (amenity) => {
  ...
  if (
    ...
    lower.includes("ac") ||
    lower.includes("climate control")
  ) {
  ...
  if (
    ...
    return (
      <LocalLaundryServiceIcon sx={{ fontSize: 20, color: "text.secondary" }} />
    );
  }
  ...
  // Non-Smoking
  if (
    lower.includes("smoke free") ||
    lower.includes("non-smoking") ||
...
export default function HotelDetails() {
  ...
  const handleBookNow = () => {
    ...
    // Trigger the chatbot with a booking intent
    const event = new CustomEvent("openChatbot", {
      detail: {
        message: `I would like to book a stay at ${hotelName}. Can you help me with availability and rates?`,
        autoSend: true,
      },
    });
